...
public class Bachelor extends Aspirer implements Nota {
	 ...
	 * @param average Promedio de las clases de 4to y 5to Bachillerato
	 * @param type Tipo de aspirante
	 * @param desvinculado El aspirante es desvinculado de Bachillerato o no
