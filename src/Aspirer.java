...
public class Aspirer {
	 ...
	 * @param type Tipo de aspirante. True es graduado de bachillerato, false es graduado de secundaria
	 * @param desvinculado Si el alumno es desvinculado (true) o no (false)
